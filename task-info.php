              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="number" name="t_weeks" id="t_days" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-5">Duration (Days)</label>
                    <div class="col-sm-7">
                      <input type="number" name="t_days" id="t_days" class="form-control">
                    </div>
                  </div>
                 <!-- <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_task_post" class="btn btn-success-custom">Add Task</button>
                    </div>
                    <div class="col-sm-3">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
          ...
          <center ><h3>Log Sheet Section</h3></center>
          <div class="gap"></div>
            ...
            <table class="table table-codensed table-custom">
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $row['t_weeks']; ?></td>
                  <td><?php echo $row['t_days']; ?></td>
                  <td>
